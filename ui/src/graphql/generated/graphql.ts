...
export type AccountFormCurrenciesQuery = {
  __typename: 'Query'
...
export type UpdateAccountMutation = {
  __typename: 'Mutation'
  updateAccount: { __typename: 'Account'; id: string } & {
    ' $fragmentRefs'?: { AccountFieldsFragment: AccountFieldsFragment }
  }
}
...
export type TransactionFieldsFragment = {
  ...
  createdAt: string
  account: { __typename: 'Account'; id: string; currency: string }
  destinationAccount?: { __typename: 'Account'; id: string; currency: string } | null
  category?: { __typename: 'Category'; id: string; name: string; icon: string } | null
} & { ' $fragmentName'?: 'TransactionFieldsFragment' }

export type MeForCurrencyQueryVariables = Exact<{ [key: string]: never }>

export type MeForCurrencyQuery = {
  __typename: 'Query'
  me?: {
    __typename: 'User'
    id: string
    defaultCurrency: { __typename: 'CurrencyInfo'; code: string; minorUnits: number }
  } | null
}

export type AccountsMeQueryVariables = Exact<{ [key: string]: never }>

export type AccountsMeQuery = {
  __typename: 'Query'
  me?: { __typename: 'User'; id: string; balance: number } | null
}
...
export type AccountsQuery = {
  ...
  accounts: {
    ...
    edges: Array<{
      __typename: 'AccountEdge'
      cursor: string
      node: { __typename: 'Account'; id: string; balance: number } & {
        ' $fragmentRefs'?: { AccountFieldsFragment: AccountFieldsFragment }
      }
    }>
...
export type EditTransactionQuery = {
  __typename: 'Query'
  transaction?: {
    __typename: 'Transaction'
    id: string
    ...
    destinationAccount?: { __typename: 'Account'; id: string } | null
    category?: { __typename: 'Category'; id: string } | null
  } | null
}

export type AddTransactionCategoriesQueryVariables = Exact<{ [key: string]: never }>

export type AddTransactionCategoriesQuery = {
  __typename: 'Query'
  categories: {
    __typename: 'CategoryConnection'
    edges: Array<{
      __typename: 'CategoryEdge'
      node: { __typename: 'Category'; id: string; name: string; icon: string; kind: CategoryKind }
    }>
  }
}

export type AddTransactionAccountsQueryVariables = Exact<{ [key: string]: never }>

export type AddTransactionAccountsQuery = {
  __typename: 'Query'
  accounts: {
    __typename: 'AccountConnection'
    edges: Array<{
      __typename: 'AccountEdge'
      node: { __typename: 'Account'; id: string; name: string; icon: string; currency: string }
    }>
  }
}
...
export type UpdateTransactionMutation = {
  __typename: 'Mutation'
  updateTransaction: { __typename: 'Transaction'; id: string } & {
    ' $fragmentRefs'?: { TransactionFieldsFragment: TransactionFieldsFragment }
  }
}
...
export type AuthCurrenciesQuery = {
  __typename: 'Query'
  currencies: Array<{ __typename: 'CurrencyInfo'; code: string; name: string }>
}
...
export type SignInMutation = {
  __typename: 'Mutation'
  signIn: { __typename: 'AuthPayload'; token: string }
}
...
export type CategoriesQuery = {
  ...
  categories: {
    ...
    edges: Array<{
      __typename: 'CategoryEdge'
      cursor: string
      node: { __typename: 'Category'; id: string; kind: CategoryKind } & {
        ' $fragmentRefs'?: { CategoryFieldsFragment: CategoryFieldsFragment }
      }
    }>
    pageInfo: { __typename: 'PageInfo'; hasNextPage: boolean; endCursor?: string | null }
...
export type DashboardMeQueryVariables = Exact<{ [key: string]: never }>

export type DashboardMeQuery = {
  __typename: 'Query'
  me?: { __typename: 'User'; id: string; balance: number } | null
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'destinationAmount' } },
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'AccountFormCurrencies' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AccountFormCurrenciesQuery, AccountFormCurrenciesQueryVariables>
...
export const MeForCurrencyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'code' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'minorUnits' } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<MeForCurrencyQuery, MeForCurrencyQueryVariables>
export const AccountsMeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AccountsMe' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AccountsMeQuery, AccountsMeQueryVariables>
...
export const EditTransactionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'EditTransaction' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<EditTransactionQuery, EditTransactionQueryVariables>
export const AddTransactionCategoriesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AddTransactionCategories' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AddTransactionCategoriesQuery, AddTransactionCategoriesQueryVariables>
export const AddTransactionAccountsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AddTransactionAccounts' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AddTransactionAccountsQuery, AddTransactionAccountsQueryVariables>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'TransactionFields' } },
              ],
            },
          },
        ],
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateTransactionInput' } },
          },
        },
      ],
      selectionSet: {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AuthCurrencies' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AuthCurrenciesQuery, AuthCurrenciesQueryVariables>
...
export const DashboardMeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DashboardMe' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<DashboardMeQuery, DashboardMeQueryVariables>
